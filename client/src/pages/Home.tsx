...
type Module = "daily" | "product" | "bank" | "history" | "bot";
...
export default function Home() {
  ...
  const nav = [{ id: "daily" as Module, label: "รับเงินรายวัน", icon: Banknote }, { id: "bot" as Module, label: "Bot Dashboard", icon: Bot }, { id: "product" as Module, label: "ผ่อนสินค้า", icon: Package }, { id: "bank" as Module, label: "หนี้ธนาคาร", icon: CreditCard }, { id: "history" as Module, label: "ประวัติรายการ", icon: History }];
  ...
  return (
    <div className="app-shell">
      ...
      <main className="workbench">
        ...
        <section className="hero-strip"><div><span className="eyebrow amber">{active === "bot" ? "BOT / INTENT CONSOLE" : "LEDGER / DAILY VIEW"}</span><h2>{active === "bot" ? <>แยกยอดวันนี้<br /><em>ออกจากสรุปรายเดือน</em></> : <>คำนวณยอดที่ต้องเก็บ<br /><em>ก่อนรับเงินก้อนนี้</em></>}</h2><p>{active === "bot" ? "ดู Intent เช็คยอดและสรุปรายเดือนในคนละส่วน พร้อมส่งคำสั่ง Bot ที่รองรับทั้งหมดอย่างเป็นระบบ" : "กรอกข้อมูลทางซ้าย แล้วดูยอดสุทธิ ดอกเบี้ย และตารางรับชำระได้ทันที"}</p></div><div className="hero-art"><img src="/manus-storage/ledger-workbench-illustration_2b058290.png" alt="โต๊ะทำงานและสมุดบัญชี" /></div></section>
        <div className="content-area">
          {active === "bot" && <BotDashboard />}
